...
def test():
    ...
    # model_dir = './saved_models/over_sample'
    # tokenizer_4 = BertTokenizer.from_pretrained(model_dir)
    # config = BertConfig.from_pretrained(model_dir)
    # model_4 = multi_lingle.Model.from_pretrained(model_dir, config=config).cuda(gpu_id)
